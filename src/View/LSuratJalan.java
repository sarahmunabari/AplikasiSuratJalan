 ...
 * @author Asus
 */
public class LSuratJalan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LAPORAN PENGIRIMAN");
    ...
    private void cmdcetak1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdcetak1ActionPerformed
        // TODO add your handling code here:
        try{
            String NamaFile = "src/View/rptPengiriman.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LSuratJalan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LSuratJalan().setVisible(true);
            }
        });
    }
